...
def test_dvui001_disable_props_check_config(dash_duo):
    ...
    class DashView(BaseDashView):
        ...
        dash._dev_tools.props_check = False
        dash._dev_tools.serve_dev_bundles = True
        # dash._dev_tools.hot_reload = True
        dash._dev_tools.silence_routes_logging = True
...
def test_dvui002_disable_ui_config(dash_duo):
    ...
    class DashView(BaseDashView):
        dash = app
        dash._dev_tools.ui = False
        dash._dev_tools.props_check = True
        dash._dev_tools.serve_dev_bundles = True
        dash._dev_tools.silence_routes_logging = True
